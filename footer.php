...
?>
	...
	<div id="footer">
		<div class="container">
			<p class="text-muted">&copy; Copyright <?php echo date('Y'); ?>. Some Rights Reserved. <?php printf( __( 'Website by %1$s.', 'customtheme' ), '<a href="http://www.paul-stephan-birza.com/" rel="author" target="_blank">Paul Birza</a>' ); ?></p>
		</div>
	</div>
