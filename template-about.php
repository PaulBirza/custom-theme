      ...
      <div role="tabpanel">
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane" id="download">
            ...
            <p class="text-muted"><a href="https://github.com/paulstephanbirza/customtheme" target="_blank">https://github.com/paulbirza/customtheme</a></p>
            <h3>Clone the Repository</h3>
            <div id="copy-wrapper">
              <span class="code text-muted copytext">git clone https://github.com/paulbirza/customtheme.git</span>
            </div>
            <h3>Contributing</h3>
